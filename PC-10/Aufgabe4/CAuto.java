...
//add implements IFahrzeug
{
   ...
   */
    ...
    public CAuto( final String p_farbe, final String p_marke, final int p_anzahlGaenge, final int p_maxGeschwindigkeit)
    {
        ...
        System.out.println("Farbe : " + m_farbe);
        System.out.println("Marke : " + m_marke);
        System.out.println("AnzahlGaenge : " + m_anzahlGaenge);
        System.out.println("MaxGeschwindigkeit : " + m_maxGeschwindigkeit);
